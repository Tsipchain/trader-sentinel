...
export const CONFIG = {
  ...
  // WalletConnect Configuration — set via EXPO_PUBLIC_WALLETCONNECT_PROJECT_ID env var
  WALLETCONNECT_PROJECT_ID: process.env.EXPO_PUBLIC_WALLETCONNECT_PROJECT_ID ?? 'b4954b0dc4eb9832e0f03ef0f25cc744',
